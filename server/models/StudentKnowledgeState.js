...
const ConceptUnderstandingSchema = new mongoose.Schema({
    ...
    // Normalized mastery score (0.0-1.0)
...
StudentKnowledgeStateSchema.methods.updateConcept = function (conceptData) {
    ...
    // Clamp masteryScore if provided
    if (conceptData.masteryScore !== undefined) {
        conceptData.masteryScore = Math.max(0, Math.min(100, conceptData.masteryScore));
    }
