...
router.get('/overview', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin gamification overview error: ${error.message}`);
...
router.get('/active-streaks', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin gamification streaks error: ${error.message}`);
...
router.get('/users', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin gamification users error: ${error.message}`);
...
router.post('/award-learning-credits', async (req, res) => {
    try {
        ...
        log.info('SYSTEM', `Admin awarded ${amount} credits to ${userId}`);
        ...
        log.error('SYSTEM', `Admin award credits failure: ${error.message}`);
...
router.post('/award-xp', async (req, res) => {
    try {
        ...
        log.info('SYSTEM', `Admin awarded ${amount} credits to ${userId} (legacy)`);
        ...
        log.error('SYSTEM', `Admin award credits failure (legacy): ${error.message}`);
        res.status(500).json({ message: 'Error awarding Learning Credits' });
    }
});
...
router.get('/skill-tree', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin skill tree fetch failure: ${error.message}`);
...
router.post('/skill-tree', async (req, res) => {
    try {
        ...
        log.success('SYSTEM', `Admin created skill: ${skill.skillId}`);

        res.status(201).json({ skill });

    } catch (error) {
        log.error('SYSTEM', `Admin skill creation failure: ${error.message}`);
        res.status(500).json({
...
router.put('/skill-tree/:skillId', async (req, res) => {
    try {
        ...
        log.success('SYSTEM', `Admin updated skill: ${skill.skillId}`);

        res.json({ skill });

    } catch (error) {
        log.error('SYSTEM', `Admin skill update failure: ${error.message}`);
...
router.delete('/skill-tree/:skillId', async (req, res) => {
    try {
        ...
        log.success('SYSTEM', `Admin deleted skill: ${skill.skillId}`);

        res.json({ message: 'Skill deleted successfully' });

    } catch (error) {
        log.error('SYSTEM', `Admin skill deletion failure: ${error.message}`);
...
router.get('/boss-battles', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin boss battles fetch failure: ${error.message}`);
...
router.get('/contributions', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin contributions fetch failure: ${error.message}`);
...
router.put('/contribution/:id/approve', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin contribution approval failure: ${error.message}`);
...
router.put('/contribution/:id/reject', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin contribution rejection failure: ${error.message}`);
...
router.post('/cleanup-bounties', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin bounty cleanup failure: ${error.message}`);
...
router.post('/cleanup-boss-battles', async (req, res) => {
    try {
        ...
        log.error('SYSTEM', `Admin boss battle cleanup failure: ${error.message}`);
