...
router.post('/generate', async (req, res) => {
    ...
    try {
        ...
        log.error('TUTOR', `Failed to create learning path: ${error.message}`);
...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        log.error('TUTOR', `Failed to retrieve learning paths: ${error.message}`);
...
router.put('/:pathId/modules/:moduleId', async (req, res) => {
    ...
    try {
        ...
        log.error('TUTOR', `Failed to update module status: ${error.message}`);
...
router.delete('/:pathId', async (req, res) => {
    ...
    try {
        ...
        log.error('TUTOR', `Failed to delete learning path: ${error.message}`);
