...
const LeaderboardPage = () => {
    ...
    return (
        <div className="h-full overflow-y-auto bg-background-light dark:bg-background-dark pt-20 pb-12">
            <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-5xl">
                <div className="flex items-center gap-6 mb-8 border-b border-yellow-500/20 pb-6">
                    <button
                        onClick={() => navigate(-1)}
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-text-light dark:text-text-dark tracking-tight mb-1 uppercase">
                                Student Leaderboard
                            </h1>
