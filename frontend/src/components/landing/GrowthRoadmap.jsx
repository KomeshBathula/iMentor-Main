                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    >
                        <div className="relative">
                                ...
                                <div className="grid grid-cols-5 grid-rows-4 gap-4 p-8 min-h-[400px]">
                                    ...
                                    {[
                                        ...
                                        <div key={i} className={`flex flex-col items-center gap-1 ${node.pos}`}>
                                            <div
                                                className={`w-12 h-12 rounded-full ${node.color} flex items-center justify-center shadow-lg border-4 border-gray-900 relative hover:scale-[1.2] transition-transform`}
                                            >
                            ...
                            {/* Floating Stats */}
                            <div
                                className="absolute -bottom-6 -right-6 md:right-12 bg-gray-900 p-4 rounded-2xl shadow-2xl border border-gray-800 animate-bounce"
                            >
