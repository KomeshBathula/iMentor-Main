        ...
        <section className="py-24 bg-black relative overflow-hidden border-t border-gray-900">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Card 1: Streaks */}
                    <AnimateOnView
                        className="bg-gray-900 rounded-2xl p-8 shadow-sm border border-gray-800 relative overflow-hidden group hover:shadow-2xl hover:-translate-y-2.5 transition-all"
                        animation="slide-up"
                        delay={100}
                    >
