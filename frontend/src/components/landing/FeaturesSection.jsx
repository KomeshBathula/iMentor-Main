...
const FeatureCard = ({ icon: Icon, title, description, index }) => (
    <AnimateOnView
        ...
        duration="0.5s"
        delay={index * 100}
        className="relative group p-8 rounded-2xl bg-gray-900 border border-gray-800 shadow-lg hover:shadow-2xl hover:-translate-y-2.5 transition-all duration-300"
    >
        {/* Hover Border Effect */}
