...
const HowItWorksSection = () => {
    return (
        <section id="how-it-works" className="py-20 lg:py-28 bg-black border-t border-gray-900">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto">
                    <h2 className="text-3xl sm:text-4xl font-extrabold text-white">Get Started in Minutes</h2>
                    <p className="mt-4 text-lg text-gray-400">
                        Unlock a powerful new way to study and research with a simple, intuitive workflow.
                    </p>
                </div>
                <div className="relative mt-16">
                    <div className="absolute left-1/2 -translate-x-1/2 top-5 bottom-5 w-px bg-gray-800 hidden md:block"></div>
                        ...
                        {steps.map((step, index) => (
                            ...
                            >
                                ...
                                <div className="relative flex-shrink-0">
                                    <div className="absolute -inset-2.5 bg-white/5 blur-xl rounded-full"></div>
                                    <div className="relative w-20 h-20 bg-gray-900 border-2 border-white rounded-full flex items-center justify-center">
