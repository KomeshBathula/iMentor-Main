    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {/* Total Skills */}
                <div
                    className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-4 border border-slate-700 hover:scale-[1.02] transition-transform"
                >
            ...
            {/* Overall Progress */}
            <Animate animation="slide-up" delay={200} className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-6 border border-slate-700">
                ...
                <div className="space-y-3">
                    <div className="w-full h-4 bg-slate-700 rounded-full overflow-hidden">
                        <div
                            className="h-full bg-gradient-to-r from-blue-500 via-cyan-400 to-green-400 transition-all duration-1000 ease-out"
            ...
            <button
                ...
                className="w-full py-4 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 rounded-lg font-semibold text-white flex items-center justify-center gap-3 transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-95"
            >
            ...
            {/* Info Box */}
            <Animate animation="fade-in" delay={300} className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
