...
const Button = ({
    ...
    const variantStyles = {
        ...
        monochrome: "bg-black hover:bg-gray-800 text-white focus:ring-black",
        'monochrome-outline': "border-2 border-black text-black hover:bg-gray-100 focus:ring-black",
    };
