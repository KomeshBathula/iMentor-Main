...
import { 
    LayoutDashboard, UploadCloud, MessagesSquare, BrainCircuit, Telescope, GraduationCap, PartyPopper, Plus, Sparkles, ArrowRight
} from 'lucide-react';
...
const ONBOARDING_STEPS = [
    ...
    {
        icon: Telescope,
        title: "Mode Walkthroughs Unlock Automatically",
        description: "You will get a focused mini-intro the first time you open key modes like Tutor Mode, Deep Research, Study Plan, Learning Memory, and Gamification pages.",
        visual: <OnboardingVisual icon={Telescope} label="Opens On First Visit" subLabel="One Card Per Mode" />
    },
    {
        icon: GraduationCap,
